...
namespace great
{
    ...
    //t_goutliers_process::t_goutliers_process(t_gsetbase* settings, t_glog* glog) : _log(glog)
    //{
    //    if (1)
    //    { //lvhb shut down the outputting in 202011
    //        if (_debug_outliers)
    ...
    //    _single_mix = { gnut::OBSCOMBIN::RAW_SINGLE, gnut::OBSCOMBIN::RAW_MIX, gnut::OBSCOMBIN::IF_P1 };
    //}
